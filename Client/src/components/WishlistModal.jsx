      ...
      >
        <div className="flex items-center space-x-4 w-full">
          ...
          <div className="flex-1">
            <h2 className="text-lg font-semibold text-gray-800">{wishlist.productId?.title}</h2>
            <p className="text-gray-600 font-medium">₹{wishlist.productId?.variants?.[0].price}</p>
